...
<head>
<title>Social Authentication Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Social Authentication..!</h2>
        <%
	...
	try {
					...
					if (rs.next()==true) 
					{
									...
									application.setAttribute("asname",sname);
									application.setAttribute("aid", i);
									application.setAttribute("auname", uname);
