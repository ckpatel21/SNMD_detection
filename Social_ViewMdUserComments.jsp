...
<div class="main">
  ...
  <div class="body">
	...
	String s1="",s2="",s3="",s4="",s5="",s6="",s7="",s8="", md="Emotional",md1="Depression",md2="Aggressive" ;
	...
	<table width="572" border="1">
				  <tr>
				    <td colspan="5" ><h3 style="color:#333333">Mental Disorder Detected Comments of Post: <span style="color:#CC0033"> <%=s1%></span> </h3> <h3 style="color:#333333">[Publisher: <a href="Social_UserProfile.jsp?uname=<%=s7%>&type=<%="Social_MdUser"%>"> <%=s7%></a>]  </h3></td>
			      </tr>
				  <tr>
					<td width="174" ><div align="left" class="style4 style5">
						<div align="center" class="style4"><strong>Commented User </strong></div>
					</div></td>
					<td width="146" ><div align="left" class="style4 style5">
						<div align="center" class="style6">Comment</div>
					</div></td>
					<td width="128"><div align="left" class="style4 style5">
						<div align="center" class="style6">Date</div>
					</div></td>
					<td width="145"><div align="left" class="style4 style5">
						<div align="center" class="style6">View the Details</div>
					</div></td>
				  </tr>
				...
				while ( rs.next() )
			   {
			       ...
			       String sql1="select * from filter where category='"+md+"' or category='"+md1+"' or category='"+md2+"'  ";
					...
					while ( rs1.next() )
			             ...
			             String t2=rs1.getString(2).toLowerCase();
			                 ...
			                 count1++;
									 %>
							  <tr>
								<td width="174" height="0"  style="color:#000000;"><div align="center"><a href="Social_UserProfile.jsp?uname=<%=s3%>&type=<%="Social_MdUser"%>" style="color:#CC0066"><b><%=s3%></b></a></div></td>
								...
								<td width="145" height="0"  style="color:#000000;"><div align="center" class="style5">
								<a href="Social_PostDetails.jsp?pname=<%=s1%>&uname=<%=s7%>&type=<%="Social_MdUser"%>" style="color:#006600"><strong>View&nbsp;</strong></a></div></td>
							  </tr>
					...
					if(mdrs.next()==true)
					{
						...
						mdst1.executeUpdate("update md_normal_count set totaluser='"+count+"', md='"+count1+"' where pname='"+s1+"' and uploader='"+s7+"' and sname='"+s8+"' ");
						
					}
					else
					{
						Statement mdst2=connection.createStatement();
						mdst2.executeUpdate("insert into md_normal_count (pname,uploader,sname,totaluser,md)values('"+s1+"','"+s7+"','"+s8+"','"+count+"','"+count1+"')");
