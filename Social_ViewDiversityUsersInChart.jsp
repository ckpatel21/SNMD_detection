...
<head>
<title>Diversity Users In Chart Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Social Diversity Users In Chart Based On Post Comments..</h2>
        <p>&nbsp;</p>
		
            <iframe width="500" height="350" src="Social_ViewDiversityUsersInChart1.jsp"></iframe>
			<div align="left"><br/>
			    <span class="style7 style14">(All Post Names)</span>		    </div>
			  				<p>&nbsp;</p>
