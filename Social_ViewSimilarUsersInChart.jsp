...
<head>
<title>Similar Users In Chart Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Social Similar Users In Chart Based On Post..</h2>
        <p>&nbsp;</p>
		
            <iframe width="500" height="350" src="Social_ViewSimilarUsersInChart1.jsp"></iframe>
			<div align="left"><br/>
