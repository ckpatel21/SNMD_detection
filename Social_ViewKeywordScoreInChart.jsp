...
<head>
<title>Keyword Score Chart Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Keyword Score In Chart..</h2>
        <p>&nbsp;</p>
		
            <iframe width="500" height="350" src="Social_ViewKeywordScoreInChart1.jsp"></iframe>
			<div align="left"><br/>
			    <span class="style7 style14">(All User Searched Keywords)</span>		    </div>
			  				<p>&nbsp;</p>
