...
<head>
<title>All Friends Posts Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">User <%=(String)application.getAttribute("uname")%>'s Friends Posts..</h2>
        <table width="622" border="1" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						String str1="select * from frdrequest where ((requestfrom='"+s1+"'&&requestto='"+user+"') || (requestfrom='"+user+"'&&requestto='"+s1+"'))&& status='Accepted'"; 
            ...
            <tr>
			 ...
			 <td  width="105" align="left" valign="middle" height="23"><a href="User_ViewPostComments.jsp?up_Name=<%=s1%>&type=<%="Friends_Posts"%>&pname=<%=s0%>" class="style8" style="color:#FF3333">View Comments</a>		  </td>
