...
<head>
<title>Social User  Re-Login Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Invalid Login Details, Please Try Again!!</h2>
        <form id="form1" name="form1" method="post" action="SocialAuthentication.jsp">
					...
					<table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td width="253"><input id="name" name="uname" class="text" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <strong> New User?</strong></span><a href="SocialRegister.jsp" class="style30"> Register </a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
