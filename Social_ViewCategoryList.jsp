...
<head>
<title>Filter Category List Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Filter Category List..</h2>
        <table width="250" border="1" align="left"  cellpadding="0" cellspacing="0">
		          ...
		          <p align="left">&nbsp;</p>
		          <p align="left">&nbsp;</p>
		          <p align="left"><a href="Social_AddFilterCategory.jsp" class="style16">Back</a></p>
