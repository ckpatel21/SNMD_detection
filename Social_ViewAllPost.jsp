...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">All <%=(String)application.getAttribute("asname")%> Users Posts..</h2>
        <table width="700" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="81" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4 style6" ><strong>Post Location </strong></div></td>
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
							String sname=(String)application.getAttribute("asname");
						   	String query="select * from posts where sname='"+sname+"' "; 
            ...
            <tr>
			  ...
			  <td height="0"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style4" >
                    <div align="center">
                   <a href="Social_UserProfile.jsp?uname=<%=s1%>&type=<%="Social_UserPosts"%>"> <%out.println(s1);%> </a>
                </div>
              </div></td>
			 ...
			 <td  width="105" align="left" valign="middle" height="23"><a href="Social_ViewPostComments.jsp?pname=<%=s0%>&uname=<%=s1%>" class="style8" style="color:#FF3333">View Comments</a>		  </td>
			...
			<p>&nbsp;</p>
		<div align="right" class="style22"><a href="SocialMain.jsp" class="style11">Back</a></div>
