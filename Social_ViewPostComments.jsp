    ...
    <div class="body_resize">
      <div class="left">
         ...
         <p><table width="565" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
			...
			<div align="left" class="style8" style="margin-left:20px;">Date</div></td>
					...
					<%
						...
						try 
						{
							String sql="select * from comments where pname='"+pname+"' and uploader='"+uname+"' ";
		...
		<tr>
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="Social_UserProfile.jsp?uname=<%=s2%>&type=<%="Comments"%>&pname=<%=pname%>&puser=<%=uname%>"><%=s2%></a></div></td>
...
<%					
			...
			<div align="right">
		          <p>&nbsp;</p>
		          <p><a href="Social_ViewAllPost.jsp" class="style14">Back</a></p>
            </div>
