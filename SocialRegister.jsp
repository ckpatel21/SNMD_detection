...
<head>
<title>Social User Registration Page</title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Welcome To Social Network User Registration..</h2>
       <form id="form1" name="form1" method="post" action="SocialRegisterStatus.jsp">
					...
					<table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td width="253"><input id="uname" name="uname" class="text" /></td>
                      </tr>
                      <tr>
